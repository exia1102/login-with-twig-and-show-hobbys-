...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#">NY-1</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	$login_wrong=false;
	if ($_POST){
		$result = loginCheck($_POST['user-email'],$_POST['user-password']);
		if($result){
			$newURL="./user.php";
			session_start();
	...
	<div class="container mt-5">
		<div class="jumbotron">
		  <h1 class="display-5">Login into NY</h1>
			<form method="POST">
...
<!-- 			  <div class="form-group form-check">
			  ...
			  if($login_wrong){
				  ...
				  Login error: username and password is incorrect
				</div>
			<?php
			  }
